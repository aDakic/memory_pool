...
{
    EXPECT_NO_THROW(memory_pool::memory_chunk chunk());
}

TEST(test_memory_chunk, construction)
{
    EXPECT_NO_THROW(memory_pool::memory_chunk chunk1(100, 100));
    EXPECT_NO_THROW(memory_pool::memory_chunk chunk2(1000, 1000));
    EXPECT_NO_THROW(memory_pool::memory_chunk chunk3(10000, 10000));
}

TEST(test_memory_chunk, chunk_size_and_count)
{
    memory_pool::memory_chunk chunk(100, 101);
...
{
    memory_pool::memory_chunk chunk1(10, 12);
    memory_pool::memory_chunk chunk2 = std::move(chunk1);
    ...
    memory_pool::memory_chunk chunk3(13, 14);
...
{
    memory_pool::memory_chunk chunk(4, 2);
